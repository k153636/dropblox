...
export default function Sidebar({ isOpen, onToggle }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-[13px] bg-zinc-950/65 backdrop-blur-2xl rounded-t-[21px] rounded-b-[13px] shadow-[0_8px_40px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,255,255,0.07)] z-[40] transition-all duration-300 ease-out ${
